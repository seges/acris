...
java -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,address=8001,suspend=y -Xmx512m -classpath $CLASSPATH -Djava.rmi.default=true sk.seges.synapso.service.ContentGeneratorService
