package sk.seges.acris.generator.server.processor.io;
...
public class FileTokenProvider implements TokenProvider {
	...
	private static final Logger log = Logger.getLogger(FileTokenProvider.class);

	private static final long MAX_PROCESSING_TIME = 120 * 10 * 60 * 1000; // 10 mins

	private String tokensDirectory;

	public FileTokenProvider(String tokensDirectory) {
