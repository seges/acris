...
import sk.seges.acris.generator.server.processor.post.annihilators.EmptyKeywordsMetaTagPostProcessorTest.EmptyKeyWordsTestConfigurationLoader;
...
public class EmptyKeywordsMetaTagPostProcessorTest extends AbstractProcessorTest {
	...
	public void testEmptyKeywordsPostProcessor() {
		runTest(HTML_FILE_DIRECTORY + "4_test_empty_keywords_input.html", 
				HTML_FILE_DIRECTORY + "4_test_empty_keywords_result.html");
	}
}