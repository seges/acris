		...
		if (Window.Location.getParameter(SESSIONS_PARAMETER) != null) {
			...
			GWT.runAsync(new RunAsyncCallback() {
				...
				public void onSuccess() {
					...
					final ElementXpathCache elementXpathCache = new ElementXpathCache(50);
					...
					SessionsPresenter sessionsPresenter = new SessionsPresenter(new PresenterProvider<SessionPresenter>() {
						...
						public SessionPresenter getPresenter() {
							return new SessionPresenter(new TutorialPlayer(true), playerService, elementXpathCache);
						}
			...
			GWT.runAsync(new RunAsyncCallback() {
				...
				@Override
				public void onSuccess() {
					new BatchRecorder(new ElementXpathCache(50)).startRecording();
				}
			});
		}
	}
