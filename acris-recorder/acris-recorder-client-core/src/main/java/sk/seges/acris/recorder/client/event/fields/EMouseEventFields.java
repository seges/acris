...
public enum EMouseEventFields implements IEventFields {
	...
	EVENT_CLIENT_X(EVENT_ACTION_TYPE, 13, MouseEvent.CLIENT_X_ATTRIBUTE),
	EVENT_CLIENT_Y(EVENT_CLIENT_X, 13, MouseEvent.CLIENT_Y_ATTRIBUTE),
	EMPTY(EVENT_CLIENT_Y, 1, 0),
	EVENT_TYPE(EMPTY, 1, 0),
	...
	EVENT_SCREEN_X(EVENT_BUTTON, 14, MouseEvent.SCREEN_X_ATTRIBUTE),
