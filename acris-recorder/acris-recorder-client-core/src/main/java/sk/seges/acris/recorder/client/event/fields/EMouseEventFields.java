...
public enum EMouseEventFields implements IEventFields {
	...
	EVENT_BUTTON(EVENT_RELATIVE, 1, MouseEvent.BUTTON_ATTRIBUTE),
	EVENT_EMPTY_4(EVENT_BUTTON, 10),
	...
	EVENT_TYPE_1(EVENT_ACTION_TYPE, 5),
	EVENT_CLIENT_X_LO(EVENT_TYPE_1, 7, MouseEvent.CLIENT_X_LO_ATTRIBUTE),
	EVENT_TYPE_2(EVENT_CLIENT_X_LO, 1),
	EVENT_CLIENT_X_HI(EVENT_TYPE_2, 7, MouseEvent.CLIENT_X_HI_ATTRIBUTE),
	EVENT_TYPE_3(EVENT_CLIENT_X_HI, 7),
	EVENT_TYPE(EVENT_TYPE_3, 1, 0),
