...
public class EncodingTest extends AbstractEventTest {
	...
	public void testEncodeMouseEvents() {
		testEvent(new MouseTestEvent(BrowserEvents.CLICK), "0001100000000000100000000000000010000010010110000000001100100000");
		testEvent(new MouseTestEvent(BrowserEvents.DBLCLICK), "0001100000000000100000000000000010000010010110000000001100100001");
		testEvent(new MouseTestEvent(BrowserEvents.MOUSEDOWN), "0001100000000000100000000000000010000010010110000000001100100010");
		testEvent(new MouseTestEvent(BrowserEvents.MOUSEMOVE), "0001100000000000100000000000000010000010010110000000001100100011");
		testEvent(new MouseTestEvent(BrowserEvents.MOUSEOUT), "0001100000000000100000000000000010000010010110000000001100100100");
		testEvent(new MouseTestEvent(BrowserEvents.MOUSEOVER), "0001100000000000100000000000000010000010010110000000001100100101");
		testEvent(new MouseTestEvent(BrowserEvents.MOUSEUP), "0001100000000000100000000000000010000010010110000000001100100110");
		testEvent(new MouseTestEvent(BrowserEvents.MOUSEWHEEL), "0001100000000000100000000000000010000010010110000000001100100111");

		testEvent(new MouseTestEvent(BrowserEvents.CLICK, 2560, 1600, 2110, 1400), "0011001000000001010000000000000010001010111100000100000111110000");
		...
		}, "0011001000000001010000000001001110001010111100000100000111110100");
