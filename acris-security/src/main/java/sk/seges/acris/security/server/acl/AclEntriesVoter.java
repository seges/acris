...
public class AclEntriesVoter extends AbstractAclVoter {
    ...
    public AclEntriesVoter(AclService aclService, String processConfigAttribute, Permission[] requirePermission) {
