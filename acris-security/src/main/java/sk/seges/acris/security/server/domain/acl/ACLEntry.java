...
public class ACLEntry implements IDomainObject<Long> {
	...
	public static final String OBJECT_IDENTITY_ID_FIELD = "objectIdentity.id"; 
	public static final String OBJECT_IDENTITY_FIELD = "objectIdentity"; 
	public static final String SID_ID_FIELD = "sid.id"; 
	...
	/**
	 * Reference to the object on which the rights apply
	 */
	@ManyToOne
