...
public class GWTUrlMappingConfiguration {
	...
	@Bean
	public IReportDescriptionDao reportDescriptionDao() {
		return new ReportDescriptionTwigDao(objectDatastore(),
				TwigReportDescription.class);
	}

	@SuppressWarnings("unchecked")
	@Bean
	public IReportParameterDao reportParameterDao() {
		return new ReportParameterTwigDao(objectDatastore(),
				TwigReportParameter.class);
	}
	...
	public RemoteServiceServlet reportDescriptionService() {
		...
		exporter
				.setServiceInterfaces(new Class[] { IReportDescriptionService.class });
		return exporter;
	}
	...
	public IReportDescriptionService reportDescriptionOnlyService() {
		return new ReportDescriptionService(this.reportDescriptionDao(), this
				.reportParameterDao());
	}
	...
	public RemoteServiceServlet reportingService() {
		GWTRPCServiceExporter exporter = new GWTRPCServiceExporter();
		exporter.setService(new MockReportingService(this
				.reportDescriptionOnlyService()));
