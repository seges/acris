 ...
 */
public class RowValueChangeEvent<RowType> extends GwtEvent<RowValueChangeHandler> {
	/**
	 * Event Key for {@link RowValueChangeEvent}.
	 */
	public static final Type<RowValueChangeHandler> TYPE = new Type<RowValueChangeHandler>();
	...
	@Override
	protected void dispatch(RowValueChangeHandler handler) {
		handler.onRowValueChange(this);
	}

	@Override
	public com.google.gwt.event.shared.GwtEvent.Type<RowValueChangeHandler> getAssociatedType() {
		return TYPE;
	}
