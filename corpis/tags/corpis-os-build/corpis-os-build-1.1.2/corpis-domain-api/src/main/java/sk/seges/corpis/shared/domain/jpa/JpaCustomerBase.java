...
import sk.seges.corpis.shared.domain.dto.CustomerBaseDto;
...
@AssociationOverride(name = CustomerBaseDto.CORRESP_ADDRESS + "." + AddressDto.COUNTRY, joinColumns = @JoinColumn(name = DBConstraints.CORRESP_TABLE_PREFIX
			+ AddressDto.COUNTRY + "_id"))
