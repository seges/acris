...
public interface TransactionalMockRemoteService {

	MockEntityDTO findInTransaction();
	MockEntityDTO findWithoutTransaction();
	MockEntityDTO findWithoutBlob();
	MockEntityDTO findWithoutBlobBothWays(MockEntityDTO entity);
	MockEntityDTO findWithReturnBlob(MockEntityDTO entity);
}