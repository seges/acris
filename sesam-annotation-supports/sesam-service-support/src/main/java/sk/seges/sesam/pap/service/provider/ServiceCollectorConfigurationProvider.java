...
public class ServiceCollectorConfigurationProvider extends AbstractServiceCollectorConfigurationProvider {
	...
	public ServiceCollectorConfigurationProvider(ServiceTypeElement service, ClassPathTypes classpathUtils, EnvironmentContext<TransferObjectProcessingEnvironment> envContext) {
