...
public class ClassFinder {
	...
	/**
	 * The result of the last search is cached in this object, along with the URL that corresponds to each class
	 * returned. This method may be called to query the cache for the location at which the given class was found.
	 * <code>null</code> will be returned if the given class was not found during the last search, or if the result
