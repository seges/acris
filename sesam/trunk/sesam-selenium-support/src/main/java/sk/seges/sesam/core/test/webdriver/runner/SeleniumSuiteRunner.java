...
public class SeleniumSuiteRunner {
	...
	protected TestResult getTestResult(AbstractWebdriverTest testCase) {
	...
	protected HtmlReportPrinter getPrinter(AbstractWebdriverTest testCase) {
	...
	protected <T> T get(AbstractWebdriverTest testCase, Map<String, T> elements, ElementFactory<T> factory) {
    ...
    public void run(AbstractWebdriverTest test) {
    	test.setUp();
       	test.runTests();
        test.tearDown();
    }
