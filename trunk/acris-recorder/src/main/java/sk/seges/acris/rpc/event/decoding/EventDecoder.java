package sk.seges.acris.rpc.event.decoding;
...
import sk.seges.acris.rpc.event.EventType;
import sk.seges.acris.rpc.event.HtmlEvent;
import sk.seges.acris.rpc.event.IRecordableEvent;
import sk.seges.acris.rpc.event.KeyboardEvent;
import sk.seges.acris.rpc.event.MouseEvent;
import sk.seges.acris.rpc.event.fields.EHtmlEventFields;
import sk.seges.acris.rpc.event.fields.EKeyboardEventFields;
import sk.seges.acris.rpc.event.fields.EMouseEventFields;
import sk.seges.acris.rpc.event.fields.FieldDefinition;
import sk.seges.acris.rpc.event.fields.IEventFields;
import sk.seges.acris.rpc.event.generic.AbstractGenericEvent;
import sk.seges.acris.rpc.transfer.StringMapper;
