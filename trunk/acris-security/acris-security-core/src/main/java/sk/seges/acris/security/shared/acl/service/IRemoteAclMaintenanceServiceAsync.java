...
public interface IRemoteAclMaintenanceServiceAsync {
	...
	public void resetACLEntries(Long aclId, UserData user, Permission[] authorities, AsyncCallback<Void> callback);
	...
	public void resetACLEntriesLoggedRole(Long aclId, Permission[] permissions, AsyncCallback<Void> callback);
}
