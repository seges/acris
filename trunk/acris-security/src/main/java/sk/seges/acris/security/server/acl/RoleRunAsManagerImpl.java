...
public class RoleRunAsManagerImpl implements RunAsManager, InitializingBean {
	...
	public Authentication buildRunAs(Authentication authentication,
		...
		while (iter.hasNext()) {
			...
			if (this.supports(attribute)) {
				String role = attribute.getAttribute().substring(
						attribute.getAttribute().lastIndexOf("RUN_AS_") + "RUN_AS_".length());
