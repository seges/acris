...
@Repository
public class TwigUserDao extends AbstractTwigCrud<TwigGenericUser> implements IGenericUserDao<TwigGenericUser> {

	protected TwigUserDao(ObjectDatastore datastore) {
	...
	@Override
	public TwigGenericUser collectUserAuthorities(UserData user, GroupAuthoritiesHolder<? extends UserPermission> authoritiesHolder, boolean addMode) {
